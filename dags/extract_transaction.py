...
def extract_transaction():
    ...
    def extract():
        ...
        df['topup_id'] = df['topup_id'].fillna(0)
    ...
    def create_clickhouse_table():
        ...
        sql_path = f"{AIRFLOW_HOME}/sql/clickhouse/ddl/transaction.sql"
    ...
    def load_to_clickhouse(s3_key: str):
        ...
        columns_query = "DESC TABLE transaction"
        ...
        sql_query = f"""
        INSERT INTO transaction ({', '.join(clickhouse_columns)})
